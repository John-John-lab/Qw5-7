...
def update_task_table_only(current_page, version, lock_state, analysis_trigger):
    ...
    # ⚡ CRITICAL PERFORMANCE FIX: Use optimized render_task_table_row() helper
    # This replaces the slow inline for-loop (previously lines 3904-4073) which took 5+ minutes
    # The optimized list comprehension with dedicated helper function reduces rendering to ~5 seconds
